...
export interface GovernanceStackConfig {
   ...
   * Auto-injected into pay.agentBudget.agentDepth when pay is configured with agentBudget.
   * Should match CreateKoiOptions.parentPid.depth + 1 (computed in @koi/starter).
   */
