...
- `@koi/scratchpad-conformance` (packages/lib/scratchpad-conformance) - Shared bun:test conformance suite for ScratchpadComponent implementations. Tests: 1. Docs: -.
...
- `@koi/workspace-conformance` (packages/lib/workspace-conformance) - Shared bun:test conformance suite for WorkspaceBackend implementations. Tests: 1. Docs: -.
