...
**Annotation keywords:** `$schema`, `title`, `description`, `$comment` — accepted at any level but not used for validation. This allows operators to use standard schema files generated by tooling without manual stripping.
