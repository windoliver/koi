...
7g16aa. `Phase 1 local-bridge + nexusPermissionsEnabled=true (explicit): throws security gate, no fall-through, no warning-only path` (single behavior across spec/tests/migration)
