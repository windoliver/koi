...
**L0-utility packages** (45 total — canonical list lives in `scripts/layers.ts` → `L0U_PACKAGES`):
`@koi/ace-types`, `@koi/bash-ast`, `@koi/bash-classifier`, `@koi/bash-security`, `@koi/blob-cas`, `@koi/browser-a11y`, `@koi/channel-base`, `@koi/config`, `@koi/context-manager`, `@koi/crystallize`, `@koi/dashboard-client`, `@koi/dashboard-types`, `@koi/dream`, `@koi/edit-match`, `@koi/errors`, `@koi/event-delivery`, `@koi/execution-context`, `@koi/file-resolution`, `@koi/file-type`, `@koi/forge-types`, `@koi/fs-scoped`, `@koi/gateway-types`, `@koi/git-utils`, `@koi/hash`, `@koi/hook-prompt`, `@koi/memory`, `@koi/model-registry`, `@koi/nexus-client`, `@koi/query-engine`, `@koi/redaction`, `@koi/replay`, `@koi/rules-loader`, `@koi/secure-storage`, `@koi/session-repair`, `@koi/settings`, `@koi/shutdown`, `@koi/skill-scanner`, `@koi/task-board`, `@koi/test`, `@koi/token-estimator`, `@koi/tools-core`, `@koi/url-safety`, `@koi/validation`, `@koi/variant-selection`, `@koi/watch-patterns`.
