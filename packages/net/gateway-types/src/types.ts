/**
 * Gateway wire protocol types, session model, routing types, config types,
 * and tool routing types. No runtime code (except pure data constants).
 *
 * Extracted from @koi/gateway to enable L2 peer packages (canvas, webhook)
 * to share types without violating the L2 isolation constraint.
 */
...
// ---------------------------------------------------------------------------
// Tool routing types (moved from tool-router.ts to break circular dep)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Config (core gateway only — no canvas/webhook fields)
// ---------------------------------------------------------------------------
