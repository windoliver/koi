 ...
 *
 * Note: the `as Record<string, unknown>` below is required because TypeScript
 * does not narrow `unknown` to an indexable type after `"code" in error`.
 * This is the safest possible widening and is a standard pattern for type guards.
 */
